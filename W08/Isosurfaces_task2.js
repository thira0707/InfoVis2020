function Isosurfaces(volume, isovalue) {
	...
	material.color = new THREE.Color("index");
	...
	function interpolated_vertex(v0, v1, s) {
		var id0 = v0.x + v0.y * volume.resolution.x + v0.z * volume.resolution.x * volume.resolution.y;
		var id1 = v1.x + v1.y * volume.resolution.x + v1.z * volume.resolution.x * volume.resolution.y;
